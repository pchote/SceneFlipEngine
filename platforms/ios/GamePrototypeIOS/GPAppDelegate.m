...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[GPViewController alloc] initWithNibName:@"GPViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[GPViewController alloc] initWithNibName:@"GPViewController_iPad" bundle:nil];
    }
